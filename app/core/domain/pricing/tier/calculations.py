...
from app.core.domain.pricing.margin.calculations import calculate_margin
...
def calculate_tier_price(
    ...
    from app.core.domain.pricing.calculations import calculate_complexity_surcharge
